...
class LoginForm extends React.Component {
    ...
    onSubmit(event){
      ...
      $.ajax({
        ...
        //url: "http://card-collection-game/auth/login",
        data: { submit:"true", login: this.state.login, password: this.state.password },
